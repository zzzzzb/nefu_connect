...
//滚动滑轮触发scrollFunc方法  //ie 谷歌
    ...
    $(".footer-left img").on("click",function(){
        if(bFlag){
            $(this).attr("src","fonts/page-2.ico");
            $(".footer-right img").attr("src","fonts/person-1.ico");
            bFlag=false;
        }
    ...
    $(".footer-right img").on("click",function(){
        if(bFlag){
            ...
            $(".footer-left img").attr("src","fonts/page-1.ico");
            $(this).attr("src","fonts/person-2.ico");
            bFlag=true;
        }
    });
    ...
    function loadData(){
        var Li=$('<li></li>'),
            ...
            content_header_img=$('<img src="img/woman1.jpg" alt="">'),
            ...
            footer_love_img=$('<img src="fonts/love.ico" alt="">'),
            ...
            footer_comment_img=$('<img src="fonts/comment.ico" alt="">'),
            ...
            footer_love_img.on("click",function(){
                ...
                if(flag){
                    ...
                    $(this).attr("src","fonts/love.ico");
                    flag=false;
                }else{
                    html2+=1;
                    $(this).parent().siblings().html(html2);
                    $(this).attr("src","fonts/love-2.ico");
                    flag=true;
                }
            });
